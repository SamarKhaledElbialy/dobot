...
def load():
    if platform.system() == "Windows":
         return CDLL("./Dobot/DobotDll/Windows/x64/DobotDll.dll", RTLD_GLOBAL) 
    elif platform.machine() == "arm64" :                                        #apple silicon, modified by nagy
        return CDLL("./Dobot/DobotDll/Mac/arm64/libDobotDll.dylib", RTLD_GLOBAL)
    elif platform.system() == "Darwin" :
        return CDLL("./Dobot/DobotDll/Mac/DobotDll/libDobotDll.dylib", RTLD_GLOBAL)
    else:
        # return cdll.LoadLibrary("./DobotDll/Linux/DobotDll/libDobotDll.so")
        return cdll.LoadLibrary("./Dobot/DobotDll/Linux/DobotDll/libDobotDll.so")
